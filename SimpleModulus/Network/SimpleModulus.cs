...
namespace WebZen.Network
{
    ...
    public class Modulus
    {
        ...
        private int EncBlock(byte[] dest, byte[] src)
        {
            ...
            EncValue = (uint)((btCheckSum << 8) | (btCheckSum ^ src.Length ^ 0x3D));

            return AddBits(dest, iBitPos, BitConverter.GetBytes(EncValue), 0, 16);
        }
